...
function FinResHeader() {
    return (
        <div className="finResHeader">
            <h1>Final</h1>
            <svg width="228" height="8" viewBox="0 0 640 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
